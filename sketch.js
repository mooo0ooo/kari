...
　const colors = colorPatterns[currentColorPattern];
  ...
  // P 行
  text("P", cx - (padLayout.btnSize * 3 + padLayout.spacing), cy - 120);
  for(let i = 0; i < 7; i++) {
    let amount = i / 6;
  ...
  // A 行
  text("A", cx - (padLayout.btnSize * 3.5 + padLayout.spacing), cy);
  for(let i = 0; i < 7; i++) {
    let amount = i / 6;
  ...
  // D 行
  text("D", cx - (padLayout.btnSize * 4 + padLayout.spacing), cy + 120);
  for(let i = 0; i < 7; i++) {
